...
public class StudentRegistration {
	...
	public String toString() {
		return "StudentRegistration [surname=" + surname + ", forename="
				+ forename + ", middlenames=" + middlenames + ", age=" + age
				+ ", title=" + title + ", sex=" + sex + ", marketing="
				+ marketing + ", additionalInfo=" + additionalInfo + "]";
	}
}
